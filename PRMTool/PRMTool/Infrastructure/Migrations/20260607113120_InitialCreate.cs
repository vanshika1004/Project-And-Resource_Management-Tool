        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForcePasswordChange = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UtilizationPercent = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "TimesheetEntryActivityTags",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimesheetEntryActivityTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TimesheetEntryActivityTags_ActivityTags_ActivityTagId",
                        column: x => x.ActivityTagId,
                        principalTable: "ActivityTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TimesheetEntryActivityTags_TimesheetEntries_TimesheetEntryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimesheetEntryActivityTags_ActivityTagId",
                table: "TimesheetEntryActivityTags",
                column: "ActivityTagId");

            migrationBuilder.CreateIndex(
                name: "IX_TimesheetEntryActivityTags_TimesheetEntryId",
                table: "TimesheetEntryActivityTags",
